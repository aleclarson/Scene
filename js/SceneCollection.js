...
var Event, Scene, SceneTree, SortedArray, Style, View, assertType, emptyFunction, modx, type;
...
type.defineMethods({
  insert: function(scene, onUpdate) {
    ...
    if (Array.isArray(scene)) {
      scene.forEach(this.insert.bind(this));
      if (onUpdate) {
        this._didUpdate.once(onUpdate);
      }
      return;
    }
...
type.render(function() {
  ...
  children = this._scenes.array.map(function(scene) {
    var key;
    key = scene.__name;
    if (isDev) {
